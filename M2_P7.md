...
### Implementation Summary
Completed multi-pass migration by removing 5 legacy fields from MaterialDefinition, updating validator to iterate material.passes, removing legacy parser branch, fixing cache/pipeline_builder fallback bugs, and creating comprehensive MIGRATION.md guide. Breaking change: Parser now rejects legacy format with error message. Result: Clean multi-pass architecture, no legacy code paths, full documentation for users.
...
**AF5: Fix pipeline_builder.cpp Fallback Logic**
...
5. **src/graphics/material_system/pipeline_builder.cpp** (lines 72, 77, 201, 320 updated)  Removed fallbacks
