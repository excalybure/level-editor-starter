...
static void drainAllEvents( platform::Win32Window &window )
{
...
TEST_CASE( "Win32Window create and basic properties", "[win32][window]" )
{
	...
	REQUIRE( window.create( "TestWindow", 320, 240, false ) );
...
#if defined( _WIN32 )
	platform::Win32Window window;
	REQUIRE( window.create( "TestWindow", 100, 100, false ) );
...
#if defined( _WIN32 )
	platform::Win32Window window;
	REQUIRE( window.create( "ResizeWindow", 200, 150, false ) );
...
TEST_CASE( "Win32Window mouse move and button events", "[win32][window]" )
{
#if defined( _WIN32 )
	platform::Win32Window window;
	REQUIRE( window.create( "MouseWindow", 200, 150, false ) );
	HWND hwnd = static_cast<HWND>( window.getHandle() );
	...
	while ( window.getEvent( ev ) )
	{
		...
		case platform::WindowEvent::Type::MouseWheel:
			wheelCount++;
			REQUIRE( ev.mouse.wheelDelta == Catch::Approx( 1.0f ) );
			break;
		default:
			break;
		}
...
#if defined( _WIN32 )
	platform::Win32Window window;
	REQUIRE( window.create( "KeyWindow", 200, 150, false ) );
	HWND hwnd = static_cast<HWND>( window.getHandle() );
	drainAllEvents( window );
...
#if defined( _WIN32 )
	platform::Win32Window window;
	REQUIRE( window.create( "CloseWindow", 100, 100, false ) );
	HWND hwnd = static_cast<HWND>( window.getHandle() );
	drainAllEvents( window );
...
#if defined( _WIN32 )
	platform::Win32Window window;
	REQUIRE( window.create( "FocusWindow", 100, 100, false ) );
	HWND hwnd = static_cast<HWND>( window.getHandle() );
	drainAllEvents( window );
...
#if defined( _WIN32 )
	platform::Win32Window window;
	REQUIRE( window.create( "OrderWindow", 120, 90, false ) );
	HWND hwnd = static_cast<HWND>( window.getHandle() );
	drainAllEvents( window );
...
TEST_CASE( "Win32Window multiple windows independence", "[win32][window]" )
{
	...
	REQUIRE( a.create( "A", 100, 100, false ) );
	REQUIRE( b.create( "B", 100, 100, false ) );
	...
	REQUIRE( countA == 1 );
	REQUIRE( countB == 1 );
	REQUIRE( ax == Catch::Approx( 5.0f ) );
	REQUIRE( ay == Catch::Approx( 6.0f ) );
	REQUIRE( bx == Catch::Approx( 50.0f ) );
	REQUIRE( by == Catch::Approx( 60.0f ) );
#else
	WARN( "Win32 window tests skipped: not on Win32 platform" );
#endif
}
...
#if defined( _WIN32 )
	platform::Win32Window window;
	REQUIRE( window.create( "WheelWindowNeg", 100, 100, false ) );
	HWND hwnd = static_cast<HWND>( window.getHandle() );
	drainAllEvents( window );
	REQUIRE( PostMessage( hwnd, WM_MOUSEWHEEL, MAKEWPARAM( 0, -WHEEL_DELTA ), 0 ) != 0 );
	REQUIRE( window.poll() );
...
#if defined( _WIN32 )
	platform::Win32Window window;
	REQUIRE( window.create( "ButtonsWindow", 100, 100, false ) );
	HWND hwnd = static_cast<HWND>( window.getHandle() );
	drainAllEvents( window );
...
#if defined( _WIN32 )
	platform::Win32Window window;
	REQUIRE( window.create( "InstanceWindow", 80, 60, false ) );
...
#if defined( _WIN32 )
	platform::Win32Window window;
	REQUIRE( window.create( "QuitWindow", 100, 100, false ) );
	drainAllEvents( window );
	PostQuitMessage( 0 );
...
#if defined( _WIN32 )
	platform::Win32Window window;
	REQUIRE( window.create( "First", 50, 50, false ) );
	drainAllEvents( window );
	// Second create should fail
	REQUIRE_FALSE( window.create( "Second", 60, 60, false ) );
#else
	WARN( "Win32 window tests skipped: not on Win32 platform" );
#endif
}
...
#if defined( _WIN32 )
	platform::Win32Window window;
	REQUIRE( window.create( "NoDupResize", 140, 120, false ) );
	HWND hwnd = static_cast<HWND>( window.getHandle() );
	// Drain initial events
	drainAllEvents( window );
...
#if defined( _WIN32 )
	platform::Win32Window window;
	REQUIRE( window.create( "ImGuiInputTest", 200, 150, false ) );
	HWND hwnd = static_cast<HWND>( window.getHandle() );
