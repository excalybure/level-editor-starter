...
void PrimitiveGPUBuffer::createVertexBuffer( const assets::Primitive &primitive )
{
...
void PrimitiveGPUBuffer::createIndexBuffer( const assets::Primitive &primitive )
{
...
Microsoft::WRL::ComPtr<ID3D12Resource> PrimitiveGPUBuffer::createUploadBuffer( std::size_t bufferSize, const void *data )
{
...
const PrimitiveGPUBuffer &MeshGPUBuffers::getPrimitiveBuffers( std::uint32_t index ) const
{
...
PrimitiveGPUBuffer &MeshGPUBuffers::getPrimitiveBuffers( std::uint32_t index )
{
	if ( index >= m_primitiveBuffers.size() )
	{
		console::fatal( "Primitive buffer index {} out of range [0, {})", index, m_primitiveBuffers.size() );
...
bool MeshGPUBuffers::isValid() const noexcept
{
