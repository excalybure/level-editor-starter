...
- MaterialConstants uses raw float arrays to avoid math type dependencies
...
- [x] `getMeshGPUBuffers()` by path and by shared_ptr
...
**Implementation Notes**:
- PrimitiveGPUBuffer constructor enhanced to accept optional MaterialGPU shared_ptr
- bindForRendering() method provides complete resource binding for both geometry and materials
- MeshGPUBuffers constructor added for material path integration via GPUResourceManager
