# Milestone 2 – Phase 1 (Enhanced ECS System) Remaining Work
...
|------|-------------------|-------------------------|
| Child dirty propagation | `TransformSystem::markChildrenDirty` is a stub | Recursive propagation to all descendants |
| Automatic dirty marking | Component changes do not auto-mark dirty | API/helper to mark when Transform is mutated |
...
### 2. Automatic Dirty Marking Mechanism
Options:
...
- [ ] Child dirty propagation implemented & tested.
- [ ] Name component auto-added when passing custom name.
- [ ] Hierarchy cycle/self-parent prevention tests pass.
