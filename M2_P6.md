...
3. Query `components::Hierarchy` for parent-child relationships
...
8. Update `Hierarchy` component relationships
...
4. Add menu items: Create Child, Duplicate, Delete, Rename
5. Wire menu items to existing commands
6. Show different menu for empty space (Create Root Entity)
...
2. Display current mesh path with label
3. Add "Browse" button to open asset selector (future)
4. For now, show read-only text fields
5. List all primitives in mesh
6. Add `renderMeshPrimitiveList()` helper
7. Show material overrides per primitive
8. Add `renderMaterialOverrideSlot()` for each primitive
...
4. List: Transform, MeshRenderer, Visible, Hierarchy
...
#### T4.2: Main Menu Bar
**Atomic Functionality**: Top-level menu with file operations
...
**Implementation Steps**:
1. Add `renderMainMenuBar()` method
2. Use `ImGui::BeginMainMenuBar()`
3. Add "File" menu with New, Open, Save, Save As
4. Add "Edit" menu with Undo, Redo
5. Add "View" menu with panel toggles
6. Add "Create" menu with entity primitives
7. Wire menu items to appropriate commands
...
#### T6.1: Comprehensive Integration Tests
...
#### T6.4: Documentation and Examples
...
### Integration Tests
- Complete editing workflows (T6.1)
...
### Week 1: Foundation
1. T1.1-T1.3: Basic hierarchy panel with selection
2. T2.1-T2.3: Inspector foundation with transform editing
3. T3.1-T3.3: Asset browser with navigation

### Week 2: Advanced Features
4. T1.4-T1.6: Hierarchy drag-and-drop and context menu
5. T2.4-T2.7: Complete inspector with all components
6. T3.4-T3.7: Asset browser with import and drag-drop

### Week 3: Integration and Polish
7. T4.1-T4.6: Scene editor integration
8. T5.1-T5.4: Scene serialization
9. T6.1-T6.4: Testing, optimization, and documentation
...
7. ✅ Performance meets targets with large scenes
8. ✅ All tests pass (unit, integration, performance)
9. ✅ Documentation is complete and accurate
10. ✅ Code review approval from team
