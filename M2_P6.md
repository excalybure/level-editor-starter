...
2. Add menu items:
   - **Create → Empty Entity**: Creates entity with only Name and Transform
   - **Create → Cube** (future): Creates entity with cube primitive mesh
   - **Create → Sphere** (future): Creates entity with sphere primitive mesh
   - **Create → Camera** (future): Creates entity with Camera component
   - **Create → Light** (future): Creates entity with Light component
   - **Create → From File...**: Opens file dialog to select .gltf/.glb
