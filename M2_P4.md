...
#### Acceptance Criteria:
- [ ] ImGuizmo compiles without errors
- [ ] ImGuizmo can be included in C++ modules
- [ ] Build system properly links ImGuizmo library

---

### Task 2: Core Gizmo System Module
...
5. **AF2.5**: Implement gizmo visibility and settings management
...
#### Test Strategy:
- **Unit Tests**:
  - Test GizmoResult delta calculations
  - Test selection center computation with various entity configurations
